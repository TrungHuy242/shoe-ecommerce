  ...
  return (
    <div className="men-page">
      <div className="men-header">
        <div className="men-header-content">
          ...
          <h1>Giày Nam</h1>
          <p>Khám phá bộ sưu tập giày nam với {products.length} sản phẩm</p>
        </div>
      </div>
      ...
      <div className="men-products-container">
        {products.length > 0 ? (
          ...
          <div className="no-products">
            ...
            <p>Hiện tại chưa có sản phẩm giày nam.</p>
          </div>
        )}
      </div>
    </div>
